...
import mlflow
import dagshub
dagshub.init(repo_owner='amithv0705', repo_name='networksecurity', mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self,X_train,y_train,x_test,y_test):
        ...
        #Track the experiments with mlflow for test 
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            #loading data from data_transformation artifact
